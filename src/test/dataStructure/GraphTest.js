...
test('Basic manipulation', function() {
    var a,
        k,
        opts = {},
        settings = new Configurable.configurable(opts),
        graph = {
            nodes: [
                {
                    id: 'n0',
    ...
    var myGraph = new Graph.graph(settings);
...
test('Methods and attached functions', function() {
    ...
    counter = 0;
    Graph.graph.attach('addNode', 'counterInc', function() {
        counter++;
    });

    Graph.graph.attachBefore('addNode', 'applyNodeColorPalette', function(n) {
        n.color = colorPalette[n.category];
    });

    strictEqual(
        false,
        Graph.graph.hasMethod('getNodeLabel'),
        'sigma.classes.hasMethod returns false if the method does not exist.'
    );

    Graph.graph.addMethod('getNodeLabel', function(nId) {
    ...
    strictEqual(
        true,
        Graph.graph.hasMethod('hasMethod'),
    ...
    throws(
        function() {
            Graph.graph.attach('undefinedMethod', 'counterInc', function() {});
        },
    ...
    throws(
        function() {
            Graph.graph.attachBefore('addNode', 'applyNodeColorPalette', function() {});
        },
    ...
    throws(
        function() {
            Graph.graph.attachBefore('undefinedMethod', 'applyNodeColorPalette', function() {});
        },
        /The method "undefinedMethod" does not exist./,
    ...
    throws(
        function() {
            Graph.graph.addMethod('getNodeLabel', function() {});
        },
...
test('Builtin indexes', function() {
    ...
    Graph.graph.addMethod('retrieveIndexes', function() {
        return {
...
test('Custom indexes', function() {
    ...
    Graph.graph.addIndex('nodesCount', {
    ...
    Graph.graph.addMethod('getNodesCount', function() {
